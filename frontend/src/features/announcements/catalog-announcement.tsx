...
/**
 * The catalog announcement, rendered at the top of the XORCISE Remote tab.
 *
 ...
 * about a service they did not ask about and cannot fix. Both would push the mission grid
 * down the panel for no information.
 */
export function CatalogAnnouncement() {
  const { data } = useAnnouncements();
  const announcement = announcementFor(data, "catalog");
